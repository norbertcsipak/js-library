...
historyOfEverything.addRating(5);
console.log(`An average rating of this book is: ${historyOfEverything.getAverageRating()}`);
let speed = new Movie('Jan de Bont', 'Speed', 116);
speed.toggleCheckOutStatus();
console.log(`Is this movie checked out?: ${(speed.isCheckedOut)}`);
speed.addRating(1);
speed.addRating(1);
speed.addRating(5);
console.log(`An average rating of this movie is: ${speed.getAverageRating()}`);
